  ...
  services.udev.packages = with pkgs; [
    ...
    (pkgs.writeTextFile {
      ...
      text = ''
        ...
        ATTR{idVendor}=="03fd", ATTR{idProduct}=="0009", MODE="0666"
        ATTR{idVendor}=="03fd", ATTR{idProduct}=="000d", MODE="0666"
        ATTR{idVendor}=="03fd", ATTR{idProduct}=="000f", MODE="0666"
        ATTR{idVendor}=="03fd", ATTR{idProduct}=="0013", MODE="0666"
        ATTR{idVendor}=="03fd", ATTR{idProduct}=="0015", MODE="0666"
      '';
    })
    (pkgs.writeTextFile {
      ...
      text = ''
        ACTION=="add", ATTR{idVendor}=="0403", ATTR{manufacturer}=="Xilinx", MODE:="0666"
      '';
    })
    (pkgs.writeTextFile {
      name = "ftdi-rules";
