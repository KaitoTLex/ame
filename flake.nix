{
  ...
  inputs = {
    ...
    wallpapers.url = "github:kaitotlex/wallpaper";
      ...
      nixosConfigurations = {
        kuroko = functorOSLib.system.instantiate {
          ...
          configuration =
            { pkgs, lib, ... }:
            {
              ...
              imports = [ ./hardware-configuration.nix inputs.lanzaboote.nixosModules.lanzaboote ];
		...
		desktop.localization.chinese = {
			...
			script = "traditional";
                ...
                # wallpaper!
                theming = {
                  wallpaper = "${inputs.wallpapers}/anime/N25/mafuAura.png";
		  polarity = "dark";
